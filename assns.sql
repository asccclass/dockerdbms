...
CREATE TABLE `asns` (
  ...
  `groupID` varchar(100) NOT NULL DEFAULT '0' COMMENT 'LINE群組ID',
  ...
  `member` varchar(120) NOT NULL COMMENT '組織架構表單GoogleSheetID',
  `imgurToken` varchar(200) NOT NULL COMMENT 'Imgur refresh_token',
  PRIMARY KEY (`asnsID`)
...
INSERT INTO `asns` VALUES (1,'臺北市高職學生家長會聯合會','高職聯','https://i.imgur.com/iZPiv3I.png','','80916666','tvpauweb@gmail.com','#FFFFFF','tvpauweb@gmail.com','1Nx-1f2S5OD-cAUyq5Hz-tLzgkFORGDV0pIkaeRBhh5c',''),(2,'臺北市高中學生家長會聯合會','高中聯','https://i.imgur.com/5TyzGR8.png','','','thspaweb@gmail.com','#FFFFFF','thspaweb@gmail.com','1zHwSHlET03p8_YYOGawaM2MKkib84gzuyJH0AQls9nU',''),(3,'臺北市國中學生家長會聯合會','國中聯','https://i.imgur.com/iZPiv3I.png','','80903254','jhupat.org@gmail.com','#FFFFFF','jhupatweb@gmail.com','15aZQkf_MT8EmgfqDhVnThKFFP6CQIXxmq7mhURniIEI',''),(4,'臺北市國小學生家長會聯合會','','','','','','#FFFFFF','','',''),(5,'全國高中高職家長會長協會','全長協','https://i.imgur.com/H9h3Cu8.png','','','twnapas@gmail.com','#FFFFFF','twnapas@gmail.com','1CQmOSiYv87kyuRM_YOFPOOpghzoPNyO96pC7fj6pZd8',''),(6,'臺北市高中高職家長會長協會','北長協','https://i.imgur.com/7S8Xir1.jpg','','','tapas.taipei@gmail.com','#FFFFFF','tapas.taipei@gmail.com','12V7IZekOgG3fxr9eya0OFB5xsgNoLGrtCA0PImBjQNA',''),(7,'PLG虛情假意之普龍貢團隊','','','Cbf3465e57ac53a94273364a4fd9befc3','','','#FFFFFF','','',''),(8,'台北市家長會會長協會','會長協','https://i.imgur.com/gh9s1rs.png','','','twtppatpe@gmail.com','#FFFFFF','twtppatpe@gmail.com','16MshSpwlOdtCzZWEryigaUl-uGWypJdlCqEPYCtVNrI','7904acecd12a2ff3887e6ff06f8cbab9a1c8dfcd'),(37,'國中學生家長會聯合會－秘書處','','','','','','#FFFFFF','','','');
...
INSERT INTO `beacon` VALUES ('10.16.62.165','b8:27:eb:0e:ac:1a','','','','','','','2022-07-21 08:39:03'),('','','014a06994d','福德街家中','','PI','歡迎%name%回家～','',NULL),('','','014aab5e3d','中研院資訊服務處','richmenu-de3c4a3fefb68da4068f93490fa75ce8','Pi Zero','014a2b4e69','',NULL);
...
CREATE TABLE `experience` (
  ...
  `titlez` varchar(50) NOT NULL,
  `serialz` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `experience` VALUES (1,1,'臺北市立國樂團附設青少年團103後援會','會長',1),(2,1,'臺北市立介壽國民中學47屆家長會','會長',2),(3,1,'臺北市國中學生家長會聯合會13屆','資訊總召',3),(4,1,'臺北市高中學生家長會聯合會13-14、18-19屆','資訊長',4),(5,1,'臺北市國中學生家長會聯合會14-20屆','資訊長',5),(6,1,'臺北市內湖高級工業職業學校106學年度家長會','會長',6),(7,1,'全國高中高職家長會長協會第8屆','秘書長',7),(8,1,'臺北市高職學生家長會聯合會18屆','秘書長',8),(9,1,'臺北市高中學生家長會聯合會20屆','執行長',9),(10,1,'全國高中高職家長會長協會第9屆','常務理事',10);
...
INSERT INTO `menu` VALUES (1,3,'main','richmenu-5ac78a03cddc97dc37dbc6c6115a28e0','','','教育小幫手主選單'),(2,1,'todo','richmenu-07ae64fce5d67a3506f8cb6a052522c7','main','','待辦事項選單'),(3,1,'initialTodo','richmenu-5095f070a147c219c562d432c29107da','main','','待辦事項初始化選單'),(4,1,'info','richmenu-646e9716e0588e48bf0e56bf0b642f4c','main','','個人小幫手選單'),(5,1,'youngerboss','richmenu-80f41a99097c34e11f033ed50cfefa47','main','','YoungerBoss 活動選單');
...
CREATE TABLE `person` (
  ...
  `notifyToken` varchar(100) NOT NULL DEFAULT '0' COMMENT 'LINE notify token',
...
--
-- Table structure for table `personcards`
--

DROP TABLE IF EXISTS `personcards`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `personcards` (
  `cardID` int(11) NOT NULL AUTO_INCREMENT,
  `cardStyle` varchar(30) NOT NULL COMMENT '樣板檔名稱',
  `usrNo` int(11) NOT NULL,
  `cardName` varchar(20) NOT NULL COMMENT '名片類別',
  `picture` varchar(200) NOT NULL,
  `card` text NOT NULL,
  PRIMARY KEY (`cardID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='個人名片設定';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personcards`
--

LOCK TABLES `personcards` WRITE;
/*!40000 ALTER TABLE `personcards` DISABLE KEYS */;
/*!40000 ALTER TABLE `personcards` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-09-20  1:58:15
